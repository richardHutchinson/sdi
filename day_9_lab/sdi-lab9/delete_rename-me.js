...
secondNum = parseInt(prompt("Type how many decimal places you want"));

console.log ("Here is the result you requested: " + formatNum(firstNum,secondNum));

// Problem Solving 2 - Number vs. String

alert("Start \"Problem Solving 2 - Number vs. String\"");

strNum = prompt("Type in the string number your want to convert.");
